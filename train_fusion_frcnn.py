...
model_classifier = Model([rgb_img_input,therm_img_input,roi_input], classifier)

# this is a model that holds both the RPN and the classifier, used to load/save weights for the models
model_all = Model([rgb_img_input, therm_img_input, roi_input], rpn[:2] + classifier)
...
for epoch_num in range(num_epochs):
	...
	while True:
		try:
			...
			######### Check the first term of this function (it is a list inside a list (removed) ##########
			loss_class = model_classifier.train_on_batch([Xrgb, Xtherm, X2[:, sel_samples, :]], [Y1[:, sel_samples, :], Y2[:, sel_samples, :]])
